...
One could omit all checks and access the dictionary in a try-except-block and then perform an appropriate action, but the goal here is, to have a designated function for checking dictionaries. This allows for tidier code.
"""

d = {'a':'hallo', 'b':2, 'c':3.12, 'd':True, 'e':[1,2,3], 'f':(1,2), 'g':{'a':1,'b':2}}

expected_kwargs = {'a':str, 'b':int, 'c':float, 'd':bool, 'e':list, 'f':tuple, 'g':dict}
...
for key_name, val_type in expected_kwargs.items():
